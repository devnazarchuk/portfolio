...
export const projects: Project[] = [
    {
        ...
        image: "/assets/work-rag-platform.jpg",
        icon: Globe,
        label: "Web Platform",
    ...
    {
        slug: "noventa-bakery",
        image: "/assets/work-agent-orchestrator.jpg",
        icon: ShoppingBag,
        label: "E-commerce",
    ...
    },
    {
        ...
        image: "/assets/work-code-copilot.jpg",
        icon: Camera,
        label: "Portfolio",
    ...
    },
    {
        ...
        image: "/assets/work-data-pipeline.jpg",
        icon: Code2,
        label: "Personal Site",
    ...
    },
    {
        ...
        image: "/assets/work-ml-training.jpg",
        icon: Workflow,
        label: "SaaS & Tools",
    ...
    },
    {
        ...
        image: "/assets/work-api-architecture.jpg",
        icon: Bot,
