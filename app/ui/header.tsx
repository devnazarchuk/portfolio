            ...
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="flex items-center gap-4">
                        <a href="https://github.com/devnazarchuk" target="_blank" rel="noopener noreferrer" className="text-[#723bf3] hover:text-[#723bf3]/80 transition-colors">
                            <FaGithub size={24} />
                        </a>
                        <a href="https://linkedin.com/in/devnazarchuk" target="_blank" rel="noopener noreferrer" className="text-[#723bf3] hover:text-[#723bf3]/80 transition-colors">
                            <FaLinkedin size={24} />
                        </a>
                        <a href="/artem_nazarchuk_resume_eng.pdf" target="_blank" rel="noopener noreferrer" className="text-[#723bf3] hover:text-[#723bf3]/80 transition-colors">
                            <FaFilePdf size={24} />
                        </a>
                        {/* Mobile Menu Button */}
                        <button
